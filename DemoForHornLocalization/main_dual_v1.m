...
show                       = 1;      % 0: Display one location found
model                      = 1;      % 0：Coarse Scanning 
[x,fs]=audioread(['.\Data\Task3\Type',num2str(itype),'\x',num2str(ix1),'y',num2str(iy1),'_x',num2str(ix2),'y',num2str(iy2),'_sample',num2str(isample),'.wav']);
...
%% v1: Print the result
x_true = [ix1,ix2]; y_true = [iy1,iy2];
Plot_results(xEst, yEst,x_true,y_true,x);
